## Agoric Discussion
	...
	-
	- The `makeLoopback` function seems to be relevant to this discussion. I've seen it used quite a lot over the last year or so.
	- it would be really useful to get a primer on its usage.
	-
	-
	- from `makeZoeForTest`,
	-
