...
- ## How they work
- LnL tokens are powered by CDP stablecoin protocol, Inter (or Inter Protocol). Stable-coins play a critical role in blockchain-based economies as they provide users with a stable medium-of-exchange. Instead of having to pay for goods or services with a volatile asset like Bitcoin or Ethereum, stablecoins  cryptocurrencies like $IST, $DAI, $USDC Inter's mechanism for minting $IST is very similar to Maker DAO's process for minting $DAI. Maker allows users to open “vaults” by depositing Ethereum. The user can choose to mint $IST, a cryptocurrency pegged at $1.
