...
- ## Overview
	...
	- ### The Role of the Powerbox in Delegating Authority
		...
		- Powersboxes can be dynamic
			- As mentioned above, **the acts of a powerbox passing out authority (mentioned above) is an on-going process.** This can lead to a scenario in which an application's Powerbox to find itself in a scenario in which an object that currently exists within its system makes a request for a capability that the Powerbox itself does not possess
