...
- LnL tokens are powered by CDP stablecoin protocol, Inter (or Inter Protocol). Stable-coins play a critical role in blockchain-based economies. They form the basis for marketplaces to emerge medium-of-exchange.
	...
	- For the very same reason that people use It is unrealistic to envision the future of blockchain technology being one in which users pay for goods or services with a volatile assets, such as Bitcoin or Ethereum. This. Is not specific to blockchain
	  logseq.order-list-type:: number
