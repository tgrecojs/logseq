...
- TODO [#A] queue up lessons for tomorrow #Akash-Videos
	- ## [Akash Docs Videos] #Akash
		...
		- Set up your local environment
		  logseq.order-list-type:: number
			- This lesson walks viewers through the p[] of configuring the `provider-services` CLI.
			  logseq.order-list-type:: number
			- logseq.order-list-type:: number
			- necessary environment variables
			  logseq.order-list-type:: number
			- By the end of the lesson, the viewer will have a tangible understanding of
			  logseq.order-list-type:: number
