## Agoric Discussion
	...
	-
	- A search of the agoric-sdk shows just [2 instances of `useNearRemote` being set `true`](https://github.com/search?q=repo%3AAgoric%2Fagoric-sdk%20useNearRemote%3A%20true&type=code), which is quite a small sample size, therefore I'd love to get some more input on how this function is used, when to use it, etc. Additionally,  the `makeLoopback` function because it seems relevant to these discussionss
	- from `makeZoeForTest`,
	-
	-
	-
