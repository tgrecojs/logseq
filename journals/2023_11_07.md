## Agoric Discussion
	...
	-
	- The `makeLoopback` function seems to be relevant to this discussion. I've seen it appear quite a lot  it would be really useful to get a primer on its usage.
	-
	-
	- from `makeZoeForTest`,
	-
