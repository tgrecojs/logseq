...
- LnL tokens are powered by CDP stablecoin protocol. This works similar to Maker DAO's minting process for the $DAI stablecoin. In this example, the protocol is "Inter Protocol" or "Inter". Inter's mechanism for minting $IST is very similiar to Maker.
