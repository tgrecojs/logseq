...
- ## How they work
- LnL tokens are powered by CDP stablecoin protocol, Inter (or Inter Protocol). Inter's mechanism for minting $IST is very similiar to Maker DAO's process for minting $DAI.  Both protocols br the basis for speculating on assets using leverage. They give user's the ability to mint stable-coins against collateral, and these newly minted stable-coins can be used to purchase more collateral.
-
