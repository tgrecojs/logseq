...
- ### CapData
	- #### Slots
		...
		- in the context of our offer, the receiver should know the proper way to construct the offer. Specificially, the receiver will need to map the capabilities in our offer
	- `"$0.Alleged: BoardRemoteATOM brand"`
		-
