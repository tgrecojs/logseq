...
- ## Overview
	...
	- ### The Role of the Powerbox in Delegating Authority
		...
		- Powersboxes can be dynamic
			...
			-
			-
			- The authority that required for all objects in a system to function properly      Throughout an application's lifecycle   In some instances, a Powerbox may receive a request for a capability that it does not yet posses, so
