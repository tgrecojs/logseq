...
- ## Overview
	...
	- ### The Role of the Powerbox in Delegating Authority
		...
		- The powerbox itself **must have extensive authority.**
			- At a minimum **it must hold all the authority that any of the applications it might service might need** so that it can fulfill its duty of **dynamically doles out these authorities based on POLA, to the actual instantiated application.
